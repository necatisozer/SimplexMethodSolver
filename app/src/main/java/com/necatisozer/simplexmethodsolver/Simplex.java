...
public class Simplex {
    ...
    public List<Integer> getPivotConstantIndexList() {
        return pivotConstantIndexList;
    }

    public void setPivotConstantIndexList(List<Integer> pivotConstantIndexList) {
        this.pivotConstantIndexList = pivotConstantIndexList;
    }
    ...
    // should be use in a loop to continuously compute until
    ...
    public ERROR compute() {
        ...
        pivotConstantIndexList.set(pivotRow, pivotColumn);
    ...
    // Forms a new tableau from precomputed values.
